...
const nextConfig = {
  ...
  async headers() {
    ...
    const enforceHttpsPolicy = isProd && !isE2E;
    const csp = [
      "default-src 'self'",
      ...
      "font-src 'self' data:",
      enforceHttpsPolicy ? "connect-src 'self' https:" : "connect-src 'self' https: http: ws: wss:",
      "worker-src 'self' blob:",
      "frame-src 'self' blob: https://accounts.google.com https://docs.google.com https://drive.google.com https://www.dropbox.com https://onedrive.live.com https://login.live.com https://login.microsoftonline.com https://*.sharepoint.com https://*.sharepoint-df.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
      "frame-ancestors 'self'",
      ...(enforceHttpsPolicy ? ["upgrade-insecure-requests"] : []),
    ].join("; ");
