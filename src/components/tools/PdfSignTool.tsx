    ...
    <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
      <div className="flex items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl flex items-center justify-center flex-shrink-0">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-medium text-gray-900">Draw your signature</p>
          <button
            type="button"
            className="text-sm text-[#2d85de] hover:text-[#2473c4] font-medium flex items-center gap-1 transition-colors"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full h-10 px-3 rounded-lg border border-gray-200 focus:border-[#2d85de] focus:ring-2 focus:ring-blue-100 transition-all"
          />
        </label>
        <label className="block">
          <span className="text-sm text-gray-600 font-medium">Width (pt)</span>
          <input
            type="number"
            min={50}
            value={width}
        ...
        <label className="block">
          <span className="text-sm text-gray-600 font-medium">Right margin</span>
          <input
            type="number"
            min={0}
            value={marginRight}
        ...
        <label className="block">
          <span className="text-sm text-gray-600 font-medium">Bottom margin</span>
          <input
            type="number"
            min={0}
            value={marginBottom}
