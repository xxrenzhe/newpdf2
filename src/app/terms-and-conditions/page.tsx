      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto prose prose-gray">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. Important Disclaimers</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. The Service</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Intellectual Property, User Content</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">7. User Representations and Restrictions</h2>
            <p className="text-gray-600 mb-4">By using the Service, you confirm and agree to the following:</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">9. Indemnity</h2>
            <p className="text-gray-600 mb-6">
