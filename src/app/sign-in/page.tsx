  ...
  return (
    <main className="min-h-screen auth-gradient">
      ...
      <header className="py-3 sm:py-4 px-4 sm:px-6">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <Select value={lang} onValueChange={(value) => setLang(value as typeof lang)}>
            <SelectTrigger className="w-[120px] sm:w-[140px] bg-transparent border-none">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4 py-8">
        <div className="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-6 sm:p-8 md:p-12">
          <div className="text-center mb-8 sm:mb-10">
            <h1 className="text-3xl sm:text-4xl font-bold text-[color:var(--brand-ink)] mb-3">
              {t("signIn", "Sign in")}
            </h1>
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 text-red-600 rounded-xl text-sm sm:text-base">
              {error}
            </div>
          )}
          ...
          <div className="space-y-4">
            <Button
              variant="outline"
              className="w-full h-12 sm:h-14 rounded-xl border-2 border-[color:var(--brand-line)] text-[color:var(--brand-ink)] font-semibold text-sm sm:text-base hover:bg-[color:var(--brand-cream)]"
