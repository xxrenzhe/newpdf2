      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm text-gray-400">Or, sign up with your email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-12 pl-12 pr-12 rounded-lg border-gray-200"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              ...
              className="w-full bg-[#2d85de] hover:bg-[#2473c4] disabled:bg-[#b8d9fb] text-white font-medium h-12 rounded-lg transition-colors"
            >
            ...
            <p className="text-xs text-gray-500 text-center">
              ...
              <Link href="/terms-and-conditions" className="text-[#2d85de] hover:underline">
                Terms & Conditions
              </Link>{" "}
              and the{" "}
              <Link href="/privacy-policy" className="text-[#2d85de] hover:underline">
                Privacy Policy
              </Link>
              .
            </p>
