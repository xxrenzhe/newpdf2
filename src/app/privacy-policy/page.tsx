      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto prose prose-gray">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">1. Information Collected</h2>
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">2. How Do We Process Your Information?</h2>
            <p className="text-[color:var(--brand-muted)] mb-4">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">3. With Whom We Share Your Personal Data</h2>
            <p className="text-[color:var(--brand-muted)] mb-4">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">4. How Do We Handle Your Social Logins?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
            ...
            <p className="text-[color:var(--brand-muted)] mb-6">
              Our Services offer you the ability to register and log in using your Google login, Apple Login and more. When you choose to do this, we will receive certain profile information about you from Google or Apple.
            </p>

            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">5. How Long Do We Keep Your Information?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">6. How Do We Keep Your Information Safe?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">7. Do We Collect Information From Minors?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
              <strong>In Short:</strong> We do not knowingly collect data from or market to children under 18 years of age.
            </p>

            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">8. Review or Change the Information in Your Account</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">9. Changes to this privacy policy</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
              We may modify this Privacy Policy from time to time. Any changes will be reflected on this page, along with the updated "Last updated" date.
            </p>
            <p className="text-[color:var(--brand-muted)] mb-6">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">10. Personal Data Controller</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
              Apollo Technology LLC acts as the Data Controller, responsible for collecting, processing, and storing personal data in compliance with applicable data protection laws to ensure your privacy is protected.
            </p>

            <hr className="my-12" />

            <h1 className="text-3xl font-bold text-[color:var(--brand-ink)] mb-8">Cookie Policy</h1>
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">1. What are cookies?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
              Cookies are small data files, enabling the retention of small data elements related to a visitor's interaction with the Site or use of Applications through their chosen device. Cookies are widely used by websites in order to make their websites work, or to work more efficiently, as well as to provide reporting information.
            </p>

            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">2. Why do we use cookies?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
            ...
            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">3. How can I control cookies?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
              You have the right to decide whether to accept or reject cookies. As the means by which you can refuse cookies through your web browser controls vary from browser to browser, you should visit your browser's help menu for more information.
            </p>

            <h2 className="text-2xl font-bold text-[color:var(--brand-ink)] mt-8 mb-4">4. Where can I get additional information?</h2>
            <p className="text-[color:var(--brand-muted)] mb-6">
              If you have any questions about our Privacy Policy or our Cookie Policy, please email us at{" "}
              <a href="mailto:support@qwerpdf.com" className="text-primary hover:underline">
                support@qwerpdf.com
              </a>
            </p>
          </div>
